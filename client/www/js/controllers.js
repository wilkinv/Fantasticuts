...
.controller('ListAppointsCtrl', function($scope, $ionicPopup, AppointService, $state, $http, API_ENDPOINT) {
  ...
  $scope.delete = function(appoint) {
    $scope.appoint.date = appoint.date;
    $http.post(API_ENDPOINT.url + '/deleteappointment', $scope.appoint).then(function(result) {
